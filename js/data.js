...
const SKILLS_DATA_DEFAULT = [
  ...
  {cat:'Conduite & Mécanique',icon:'🔧',items:['Vérifier la pression des pneus seul','Changer une roue en moins de 15min',
'Lire les voyants du tableau de bord',
'Changer les essuie-glaces',
'Faire le plein d huile et vérifier le niveau',
'Comprendre un devis mécanique',
'Changer les plaquettes de frein',
'Lire un compte-rendu de contrôle technique',
'Utiliser une jauge de pression',
'Nettoyer et entretenir un filtre à air',
'Régler les phares',
'Comprendre les différents types de pneus',
'Diagnostiquer un bruit suspect',
'Faire l entretien de base soi-même',
'Négocier un achat de voiture d occasion'
]},
 
{cat:'Prise de Parole en Public',icon:'🎤',items:[
'Parler 2 min sans note devant un miroir',
'Parler devant 1 personne sans hésitation',
'Gérer le silence sans paniquer',
'Structurer un discours en 3 parties',
'Présenter un sujet 5 min sans lire',
'Répondre à une question difficile sans se braquer',
'Parler devant 5 personnes',
'Utiliser le corps et les mains naturellement',
'Adapter son niveau de langage à l audience',
'Improviser sur un sujet inconnu 2 min',
'Gérer une interruption',
'Conclure avec impact',
'Parler devant 20 personnes',
'Tenir 15 min sans note',
'Donner une conférence ou exposé complet'
]},
 
{cat:'Investissement & Finances',icon:'💰',items:[
'Créer un budget détaillé sur 3 mois',
'Calculer son taux d épargne',
'Comprendre ce qu est un ETF monde',
'Ouvrir un PEA ou assurance-vie',
'Investir une première fois (même 50€)',
'Comprendre les frais cachés des produits financiers',
'Calculer l intérêt composé sur 10 ans',
'Lire un rapport annuel d entreprise',
'Comprendre la différence actions/obligations/immobilier',
'Diversifier ses investissements entre 3 classes d actifs',
'Comprendre la fiscalité des investissements en France',
'Simuler sa retraite à différents taux d épargne',
'Atteindre 3 mois de dépenses en épargne de sécurité',
'Définir une stratégie d investissement personnelle',
'Suivre son patrimoine net chaque mois'
]},
 
{cat:'Rédaction & Argumentation',icon:'✍️',items:[
'Écrire un paragraphe sans faute',
'Structurer un texte avec intro/développement/conclusion',
'Argumenter une position en 5 phrases',
'Réfuter un argument sans agressivité',
'Écrire un email professionnel convaincant',
'Résumer un article complexe en 5 lignes',
'Rédiger un texte persuasif sur un sujet difficile',
'Utiliser des exemples concrets pour appuyer une thèse',
'Adapter son style selon l audience',
 'Écrire une lettre de motivation percutante',
'Rédiger un texte sans répétitions ni remplissage',
'Tenir un journal d écriture 30 jours',
'Écrire une nouvelle courte de 2000 mots',
'Publier un article ou post réel',
'Écrire son manifeste personnel'
]},
 
{cat:'Gestion du Stress & Émotions',icon:'🧘',items:[
'Identifier ses déclencheurs émotionnels principaux',
'Pratiquer la cohérence cardiaque 5min/jour',
'Utiliser la technique 4-7-8 breathing',
'Observer une émotion sans réagir',
'Différer une réaction pendant 60 secondes',
'Journaliser ses émotions 7 jours',
'Identifier un biais cognitif chez soi',
'Pratiquer le recadrage cognitif',
'Méditer 10min pendant 30 jours consécutifs',
'Faire une visualisation de performance',
'Tenir sous pression sans perdre le fil',
'Analyser un conflit passé sans projeter',
'Pratiquer la gratitude 30 jours',
'Sortir d un état d anxiété en moins de 5 min',
'Rester stable émotionnellement pendant 7 jours difficiles'
]},
 
{cat:'Langue Anglaise Avancée',icon:'🇬🇧',items:[
'Regarder une série sans sous-titres et comprendre 70%',
'Lire un livre en anglais de 200+ pages',
'Tenir une conversation de 10 min en anglais',
'Écrire un email professionnel en anglais',
'Comprendre un podcast natif sans script',
'Parler sans traduire dans sa tête',
'Connaître 2000 mots de vocabulaire courant',
'Écrire un essai de 500 mots en anglais',
'Suivre une conférence TED sans aide',
'Avoir un débat sur un sujet complexe en anglais',
'Comprendre l humour et les références culturelles',
'Lire un article du New York Times et comprendre les nuances',
'Rédiger un CV en anglais',
'Comprendre l argot et les expressions idiomatiques courantes',
'Soutenir une conversation pendant 30 min sans basculer en français'
]},
 
{cat:'Dessin & Observation Visuelle',icon:'🎨',items:[
'Dessiner une ligne droite et une courbe maîtrisées',
'Dessiner un cube en perspective 1 point',
'Dessiner une sphère avec ombrage',
'Dessiner une main simplifiée',
'Dessiner un visage de face proportionné',
'Utiliser le négatif (l espace autour)',
'Dessiner de mémoire un objet simple',
'Faire un portrait ressemblant d une photo',
'Dessiner en perspective 2 points de fuite',
'Maîtriser les valeurs clair/obscur',
'Reproduire une illustration complexe',
'Dessiner un personnage debout avec proportions correctes',
'Créer une scène complète avec arrière-plan',
